...
if __name__ == "__main__":
    ...
    folder1_path = r"C:\Users\GeoFly\Documents\rfan\Seagrass\image\BodegaBay\BodegaBay\test\image" # folder of file names read from
    folder2_path = r"C:\Users\GeoFly\Documents\rfan\Seagrass\image\BodegaBay\glcm" # folder we copy from
    folder3_path = r"C:\Users\GeoFly\Documents\rfan\Seagrass\image\BodegaBay\BodegaBay\test\glcm" # folder we copy to
