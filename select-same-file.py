...
if __name__ == "__main__":
    ...
    folder1_path = r"D:\ML_Seagrass\SourceData\Washington\Washington\valid\image" # folder of file names read from
    folder2_path = r"C:\Users\Yang_PC\Documents\seagrass\Washington\glcm-entropy" # folder we copy from
    folder3_path = r"D:\ML_Seagrass\SourceData\Washington\Washington\valid\glcm" # folder we copy to
